        ...
        <div class="column-group uiCoverTimeLine">
            ...
            <div class="displayPhoto">
                ...
                if (!empty($otherUser->data->coverPhoto))
                {
                    ...
                    <div class="imgCover">
                        <div>
                            <a class="popupPhoto" href="/content/photo/popupPhoto?pID=<?php echo $otherUser->recordID . '_0_' . $otherUser->data->coverPhoto . '_0' ?>">
            ...
            <div class="actionCover">
                ...
                <div id="dropdown-uploadCover" class="dropdown dropdown-tip">
                    <ul class="dropdown-menu">
                        ...
                        <li><a id="uploadCover">Upload photo</a></li>
                        <?php
                        if (!empty($otherUser->data->coverPhoto) && $otherUser->data->coverPhoto != 'none')
                        {
                            ?>
                            <li><a href="javascript:void(0)" id="removeCover" title="Remove">Remove</a></li>
                        <?php } ?>
                    </ul>
            ...
            <a class="infoUser page" >
                <div class="profilePicThumb">
                    <div class="profilePicThumbImg">
                        <a class="popupPhoto" href="/content/photo/popupPhoto?pID=<?php echo $otherUser->recordID . '_0_' . $otherUser->data->profilePic . '_0' ?>">
