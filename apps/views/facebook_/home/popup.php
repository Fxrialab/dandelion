...
<div class="control-group">
    <div class="large-65">
        <div class="popupImg">
            ...
            {
                ?>
                <a  href="/content/photo/popupPhoto?typeID=<?php echo $typeID ?>&id=<?php echo str_replace(':', '_', $idp) ?>" class="pev popupPhoto"><i class="icon40-pev"></i></a>
                <?php
            }
            ?>
            <div class="img">
            ...
            {
                ?>
                <a href="/content/photo/popupPhoto?typeID=<?php echo $typeID ?>&id=<?php echo str_replace(':', '_', $idn) ?>" class="next popupPhoto"><i class="icon40-next"></i></a>
            <?php } ?>
        </div>
    </div>
    <div class="large-35">
        <div class="popupComment">
            <a class="close" href="javascript:void(0)" onclick="$.pgwModal('close');">Close</a>
