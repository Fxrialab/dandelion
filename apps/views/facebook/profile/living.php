        ...
        <ul class="menu-about-list">
            ...
            <li class="active currentCity">
                <div>
                    ...
                    <div class="large-80">
                        <a href="#" class="location"><?php echo HelperController::findLocation($information->data->current_city) ?></a>
                        <p>Current City</p>
                    </div>
            ...
            <li class="homeCity">
                <div>
                    ...
                    <div class="large-80">
                        <a href="#" class="location"><?php echo HelperController::findLocation($information->data->home_city) ?></a>
                        <p>Home City</p>
                    </div>
                    <div class="large-5 option">
