            ...
            <div class="uiForgotPWBox">
                ...
                <div class="boxContent forgotPwContent">
                    <div class="forgotContainer">
                        ...
                        <form class="ink-form top-space" method="post" action="/forgotPassword" id="fmForgotPassword">
                        ...
                        <div class="footerBox column-group">
                            <a id="searchEmail" class="uiMediumButton white large-20 push-right" href="">Search</a>
