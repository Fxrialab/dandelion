            ...
            <div class="uiForgotPWBox">
                ...
                <div class="boxContent forgotPwContent">
                    <div class="forgotContainer">
                        <form action="/confirmCode" method="post" class="ink-form" id="fmConfirmCode">
                            <div class="title content-center">
                                <span>We have sent you an email containing the confirmation code of six digits.</span>
                            </div>
                            <div class="column-group large-100">
                                <div class="large-30 leftColBox">
                                    <div class="content-right">
                                        <input type="text" size="6" name="codeAuthEmail" id="confirm">
                                    </div>
                                </div>
