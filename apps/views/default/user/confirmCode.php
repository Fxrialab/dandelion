...
<div class="loginBlock" id="forgot">
    <div class="wrapperForgot">
        ...
        <form id="confirm_form_box" action="/confirmCode" method="post">
            <div class="loginForm">
                <p class="thisform">Check email - we have sent you an email containing the confirmation code of six digits.</p>
                <div class="control-group" style="margin-left: -30px;">
                    <div class="input-prepend">
                        <div class="wrapper_input">
                            <input style="background-color: rgb(240, 231, 231); width:104px; font-size: 30px;color: #777;" name="codeAuthEmail" id="confirm" onkeyup="HideMessage();">
