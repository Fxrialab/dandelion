...
pgwjs = {checkNavbar: function() {
        ...
        $('html,body').animate({scrollTop: ($('#' + div).offset().top - 15)}, 'slow');
        return true;
    }};
/** * PgwMenu - Version 1.0 * * Copyright 2014,Jonathan M. Piat * http://pgwjs.com - http://pagawa.com * * Released under the GNU GPLv3 license - http://opensource.org/licenses/gpl-3.0 */(function(a) {
    a.fn.pgwMenu = function(c) {
        var d = {dropDownLabel: '<span class="icon"></span>', mainClassName: "pgwMenu"};
        if (this.length == 0) {
            return this
        } else {
            if (this.length > 1) {
...
window.Rainbow = function() {
    ...
    function z(a, b) {
        ...
        for (e = 0; e < c.length; ++e)
            c[e].getElementsByTagName("code").length ? c[e].innerHTML = c[e].innerHTML.replace(/^\s+/, "").replace(/\s+$/, "") : f.push(c[e]);
        for (e = 0; e < d.length; ++e)
            g.push(d[e]);
        o(g.concat(f), 0, b)
    }
    var j = {}, f = {}, m = {}, y = {}, d = 0, x = 0, s = 0, w = 0, l, p;
