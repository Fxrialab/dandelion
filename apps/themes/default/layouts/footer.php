...
<script type="text/javascript" src="<?php echo $this->f3->get('JS'); ?>jquery.pgw.js"></script>
<script type="text/javascript" src="<?php echo $this->f3->get('JS'); ?>jquery.infinitescroll.min.js"></script>
<script type="text/javascript" src="<?php echo $this->f3->get('JS'); ?>infinitescroll.js"></script>
<script type="text/javascript" src="<?php echo $this->f3->get('JS'); ?>pgwmodal.js"></script>
...
<!--<script type="text/javascript" src="<?php echo $this->f3->get('JS'); ?>libs/jquery-1.2.6.pack.js"></script>-->
