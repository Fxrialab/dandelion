                                ...
                                <div class="column-group">
                                    <div class="large-40">
                                        <div class="avatar">
                                            ...
                                            {
                                                $avatar = Controller::getID('photo', $user->data->profilePic);
                                                echo '<img src="' . UPLOAD_URL . '/avatar/170px/' . $avatar->data->fileName . '">';
                                            }
                                            else
                                            {
                                                echo '<img src="' . UPLOAD_URL . '/avatar/170px/avatar.png">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                    <div class="large-60"><div id="uploadAvatar"><a class="ink-button green">Change Picture</a></div></div>
                                </div>
