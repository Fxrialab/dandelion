...
<form class="ink-form formGroup" id="submitForm">
    ...
    <div class="control-group column-group ">
        <label for="groupName" class="large-30 align-right">Name</label>
        <div class="control large-70">
            <input type="text" id="groupName" name="groupName" class="large-100" style="line-height:20px">
        </div>
    </div>
    <div class="control-group column-group ">
        <label for="groupDescription" class="large-30 align-right">Description</label>
        <div class="control large-70">
            <textarea name="groupDescription" class="large-100"></textarea>
        </div>
    </div>
